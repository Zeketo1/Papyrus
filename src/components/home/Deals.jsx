      ...
      <div className="flex md:justify-center">
        <div className="relative flex flex-col gap-5 lg:items-start items-center">
          ...
          <div className="text-center lg:text-start">
            Gift cards are the perfect way to share joy <br /> and
            thoughtfulness with the ones you care about. <br /> They offer the
            freedom to choose something special, <br /> making every
            occasion—birthdays, holidays, <br /> or just because—more
            meaningful.
          </div>
          <Button text="Buy Now" />
